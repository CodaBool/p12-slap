// this is already used in useGLTF loader
// however, it is out of date, you can check the date on it here
// https://github.com/pmndrs/three-stdlib/blob/main/src/libs/MeshoptDecoder.js
// compared to the newer decoder here
